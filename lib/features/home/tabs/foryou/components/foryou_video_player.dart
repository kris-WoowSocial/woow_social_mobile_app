...
class ForyouVideoPlayerView extends StatefulWidget {
  final String videoUrl;
  const ForyouVideoPlayerView({Key? key, required this.videoUrl})
      : super(key: key);

  @override
  _ForyouVideoPlayerViewState createState() => _ForyouVideoPlayerViewState();
}

class _ForyouVideoPlayerViewState extends State<ForyouVideoPlayerView>
